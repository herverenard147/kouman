...
<nav id="sidebar" class="sidebar-wrapper sidebar-dark">
    <div class="sidebar-content">
        ...
        <ul class="sidebar-menu border-t border-white/10" data-simplebar style="height: calc(100% - 70px);">
            <li>
                <a href="{{route('index')}}"><i class="mdi mdi-chart-bell-curve-cumulative me-2"></i>Dashboard</a>
            </li>

            <li>
                <a href="{{route('explore-property')}}"><i class="mdi mdi-home-city me-2"></i>Explore Properties</a>
            </li>

            <li>
                <a href="{{route('favorite-property')}}"><i class="mdi mdi-home-heart me-2"></i>Favorite Properties</a>
            </li>
            ...
            <li>
                <a href="{{route('chat')}}"><i class="mdi mdi-chat-outline me-2"></i>Chat</a>
            </li>
            ...
            <li class="sidebar-dropdown">
                ...
                <div class="sidebar-submenu">
                    <ul>
                        <li><a href="{{route('starter')}}">Starter</a></li>
            ...
            <li class="sidebar-dropdown">
                ...
                <div class="sidebar-submenu">
                    <ul>
                        ...
                        <li><a href="{{route('signup-success')}}">Signup Success</a></li>
                        <li><a href="{{route('reset-password')}}">Reset Password</a></li>
                        <li><a href="{{route('lock-screen')}}">Lockscreen</a></li>
                    </ul>
                </div>
            </li>
