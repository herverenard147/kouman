        ...
        <div class="container relative">
            <div class="grid grid-cols-1">
                <div class="title-heading text-center my-auto">
                    <div class="size-24 bg-green-600/5 text-green-600 rounded-md flex align-middle justify-center items-center shadow-sm mx-auto">
                        <i data-feather="thumbs-up" class="size-10"></i>
                    </div>
                    <h1 class="mt-6 mb-8 md:text-5xl text-3xl font-bold">Thank You</h1>
                    <p class="text-slate-400 max-w-xl mx-auto">We are a huge marketplace dedicated to connecting great artists of all Kouman with their fans and unique token collectors!</p>
