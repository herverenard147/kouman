                ...
                <div class="xl:col-span-3 lg:col-span-5 md:col-span-5">
                    <div class="rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900">
                        <div class="text-center p-6 border-b border-gray-100 dark:border-gray-800">
                            <img src="{{asset('/images/client/07.jpg')}}" class="size-20 rounded-full shadow dark:shadow-gray-700 mx-auto" alt="">
                ...
                <div class="xl:col-span-9 lg:col-span-7 md:col-span-7">
                    <div class="rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900">
                        <div class="flex justify-between items-center border-b border-gray-100 dark:border-gray-800 p-4">
                            <div class="flex">
                                <img src="{{asset('/images/client/01.jpg')}}" class="size-11 rounded-full shadow dark:shadow-gray-700" alt="">
                        ...
                        <ul class="p-4 list-none mb-0 max-h-[548px]" data-simplebar>
                            <li>
                                <div class="inline-block">
                                    <div class="flex mb-3">
                                        <div class="relative">
                                            <img src="{{asset('/images/client/01.jpg')}}" class="size-9 min-w-[36px] rounded-full shadow dark:shadow-gray-700" alt="">
                                ...
                                <div class="inline-block">
                                    <div class="flex mb-3">
                                        <div class="relative order-2">
                                            <img src="{{asset('/images/client/07.jpg')}}" class="size-9 min-w-[36px] rounded-full shadow dark:shadow-gray-700" alt="">
