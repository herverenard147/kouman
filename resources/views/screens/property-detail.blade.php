        ...
        <div class="layout-specing">
            ...
            <div class="md:flex mt-4">
                <div class="lg:w-1/2 md:w-1/2 p-1">
                    <div class="group relative overflow-hidden rounded-md shadow dark:shadow-gray-700 h-full">
                        ...
                        <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
                            <a href="<?php echo !empty($article['img']) ? $static_url . $article['img'] : $static_url . '/images/property/single/1.jpg'; ?>" class="btn btn-icon bg-green-600 hover:bg-green-700 text-white rounded-full lightbox"><i class="mdi mdi-camera-outline"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex">
                        <div class="w-1/2 p-1">
                            <div class="group relative overflow-hidden rounded-md shadow dark:shadow-gray-700">
                                ...
                                <div class="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out"></div>
                                <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
                                    <a href="<?php echo $static_url; ?>/images/property/single/2.jpg" class="btn btn-icon bg-green-600 hover:bg-green-700 text-white rounded-full lightbox"><i class="mdi mdi-camera-outline"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="w-1/2 p-1">
                            <div class="group relative overflow-hidden rounded-md shadow dark:shadow-gray-700">
                                ...
                                <div class="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out"></div>
                                <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
                                    <a href="<?php echo $static_url; ?>/images/property/single/3.jpg" class="btn btn-icon bg-green-600 hover:bg-green-700 text-white rounded-full lightbox"><i class="mdi mdi-camera-outline"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex">
                        <div class="w-1/2 p-1">
                            <div class="group relative overflow-hidden rounded-md shadow dark:shadow-gray-700">
                                ...
                                <div class="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out"></div>
                                <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
                                    <a href="<?php echo $static_url; ?>/images/property/single/4.jpg" class="btn btn-icon bg-green-600 hover:bg-green-700 text-white rounded-full lightbox"><i class="mdi mdi-camera-outline"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="w-1/2 p-1">
                            <div class="group relative overflow-hidden rounded-md shadow dark:shadow-gray-700">
                                ...
                                <div class="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out"></div>
                                <div class="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
                                    <a href="<?php echo $static_url; ?>/images/property/single/5.jpg" class="btn btn-icon bg-green-600 hover:bg-green-700 text-white rounded-full lightbox"><i class="mdi mdi-camera-outline"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid lg:grid-cols-12 md:grid-cols-2 gap-6 mt-6">
                ...
                <div class="lg:col-span-4">
                    ...
                    <div class="mt-12 text-center">
                        ...
                        <div class="mt-6">
                            <a href="" class="btn bg-transparent hover:bg-green-600 border border-green-600 text-green-600 hover:text-white rounded-md"><i class="mdi mdi-phone align-middle me-2"></i> Contact us</a>
                        </div>
                    </div>
                </div>
            </div>
