...
@section('description', 'We are currently undergoing maintenance. Please check back later.')
@section('keywords', 'maintenance, real estate, properties, buy, sell, rent')
@section('content')
    ...
    <section class="md:h-screen py-36 flex items-center justify-center relative overflow-hidden zoom-image">
        ...
        <div class="container relative z-3 text-center">
            <div class="grid grid-cols-1">
                <img src="{{asset('/images/logo-icon-64.png')}}" class="mx-auto" alt="">
