                    ...
                    <div class="rounded-md shadow p-6 bg-white h-fit">
                        <div class="grid grid-cols-12 gap-5">
                            ...
                            <div class="md:col-span-6 col-span-12">
                                ...
                                <input name="ville" id="ville" type="text" class="form-input mt-2 @error('ville') border-red-500 @enderror" placeholder="Ville" value="{{ old('ville') }}" required readonly>
                                @error('ville')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-6 col-span-12">
                                ...
                                <input name="pays" id="pays" type="text" class="form-input mt-2 @error('pays') border-red-500 @enderror" placeholder="Pays" value="{{ old('pays') }}" required readonly>
                                @error('pays')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div Saying-md class="col-span-4 col-span-12">
                                ...
                                <input name="adresse" id="adresse" type="text" class="form-input mt-2 @error('adresse') border-red-500 @enderror" placeholder="Adresse complète" value="{{ old('adresse') }}" required readonly>
                                @error('adresse')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="md:col-span-4 col-span-12">
                                ...
                                <input name="latitude" id="latitude" type="number" step="0.000001" class="form-input mt-2 @error('latitude') border-red-500 @enderror" placeholder="Latitude" value="{{ old('latitude') }}" required readonly>
                                @error('latitude')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
