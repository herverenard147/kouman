@extends('layout.base')
@section('title', 'Ajouter un évènement')
@section('content')
    ...
    <div class="container-fluid relative px-3">
        <div class="layout-specing">
            ...
            <div class="md:flex justify-between items-center">
                <h5 class="text-lg font-semibold">Ajouter un évènement</h5>
                ...
                <ul class="tracking-[0.5px] inline-block sm:mt-0 mt-3">
                    ...
                    <li class="inline-block capitalize text-[16px] font-medium text-green-600" aria-current="page">Ajouter un évènement</li>
                </ul>
            </div>
                ...
                <div class="grid md:grid-cols-2 grid-cols-1 gap-6 mt-6">
                    <div class="rounded-md shadow p-6 bg-white h-fit">
                        <div>
                            ...
                            <input type="file" id="input-file" name="input-file" accept="image/*" onchange={handleChangeE()} hidden>
                    ...
                    <div class="rounded-md shadow p-6 bg-white h-fit">
                        <form class="">
                            ...
                            <button type="submit" id="submit" name="send" class="btn bg-green-600 hover:bg-green-700 border-green-600 hover:border-green-700 text-white rounded-md mt-5">Ajouter un évènement</button>
                        </form>
                    </div>
                </div>
            </div>
