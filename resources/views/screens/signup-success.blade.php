                ...
                <div class="lg:w-2/5">
                    <div class="relative overflow-hidden rounded-md bg-white shadow">
                        ...
                        <div class="text-center p-6 border-t border-gray-100">
                            <p class="mb-0 text-slate-400 font-medium">© <script>document.write(new Date().getFullYear())</script> Kw Legal & Tech. Design & Develop with  by <a href="https://kwlegaltech.com//" target="_blank" class="text-reset">kw legal tech</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
