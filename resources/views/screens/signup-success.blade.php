                ...
                <div class="lg:w-2/5">
                    <div class="relative overflow-hidden rounded-md bg-white shadow">
                        ...
                        <div class="text-center p-6 border-t border-gray-100">
                            <p class="mb-0 text-slate-400 font-medium">© <script>document.write(new Date().getFullYear())</script> Kouman. Design & Develop with <i class="mdi mdi-heart text-red-600"></i> by <a href="https://shreethemes.in/" target="_blank" class="text-reset">Shreethemes</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
