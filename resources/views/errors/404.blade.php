            ...
            <div class="grid grid-cols-1">
                <div class="flex flex-col min-h-screen justify-center md:px-10 py-10 px-4">
                    ...
                    <div class="title-heading text-center my-auto">
                        ...
                        <h1 class="mt-3 mb-6 md:text-4xl text-3xl font-bold">Page introuvable ?</h1>
                        <p class="text-slate-400">Oups, c’est embarrassant. <br> Il semble que la page que vous recherchez n’existe pas.</p>
