                ...
                <div class="flex flex-col min-h-screen justify-center md:px-10 py-10 px-4">
                    <div class="text-center">
                        <a href="{{ route('client.index') }}">
                            <img src="{{ asset('client/assets/images/d.png') }}" class="mx-auto" alt="">
                        </a>
                    </div>
                    <div class="title-heading text-center my-auto">
                        <img src="{{ asset('client/assets/images/error.png') }}" class="mx-auto" alt="">
                        <h1 class="mt-3 mb-6 md:text-4xl text-3xl font-bold">Erreur interne</h1>
                        <p class="text-slate-400">Une erreur inattendue s'est produite. Merci de réessayer plus tard.</p>
