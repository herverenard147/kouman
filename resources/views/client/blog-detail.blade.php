        ...
        <div class="container relative">
            <div class="grid grid-cols-1 text-center mt-10">
                <h3 class="md:text-3xl text-2xl md:leading-snug tracking-wide leading-snug font-medium text-white mb-3">
                    {{ !empty($article['title']) ? $article['title'] : 'Skills That You Can Learn In The Real Estate Market' }}
                </h3>
                ...
                <ul class="list-none mt-6">
                    ...
                    <li class="inline-block text-white/50 mx-5"> <span class="text-white block">Date :</span> <span
                            class="block">{{ !empty($article['date']) ? $article['date'] : '3rd March, 2024' }}</span></li>
            ...
            <div class="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 gap-[30px]">
                <div class="lg:col-span-8 md:order-1 order-2">
                    <div class="relative overflow-hidden rounded-xl shadow dark:shadow-gray-800">
                        ...
                        <img src="{{ asset('client/assets/images/property/9.jpg') }}" alt="">
                ...
                <div class="lg:col-span-4 md:order-2 order-1">
                    <div class="sticky top-20">
                        ...
                        <div class="flex items-center mt-4">
                            ...
                            <div class="ms-3">
                                <a href="" class="font-medium hover:text-green-600">10 Things You About Real
                                    Estate</a>
                        ...
                        <div class="flex items-center mt-4">
                            ...
                            <div class="ms-3">
                                <a href="" class="font-medium hover:text-green-600">110 Quick Tips About Real
                                    Estate</a>
                                <p class="text-sm text-slate-400">2nd March 2023</p>
                            </div>
                        </div>
