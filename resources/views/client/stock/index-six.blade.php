...
@section('title', 'Hously - Home Page 6')
@section('content')
        ...
        <div class="container relative z-3">
            <div class="grid md:grid-cols-12 mt-10">
                <div class="lg:col-span-8 md:col-span-6">
                    <h1 class="font-semibold text-white lg:leading-normal leading-normal text-4xl lg:text-6xl mb-6">Find the
                        perfect <br> <span class="typewrite" data-period="2000"
                            data-type='[ "home", "villa", "office" ]'></span> for you</h1>
                    <p class="text-white/70 text-xl max-w-xl">A great plateform to buy, sell and rent your properties without
                ...
                <div class="md:col-span-5">
                    <div class="relative">
                        <div class="p-5 shadow dark:shadow-gray-700 rounded-t-full bg-white dark:bg-slate-900">
                            <img src="client/assets/images/hero.jpg" class="shadow-md rounded-t-full rounded-md"
                                alt="">
                        </div>
