                ...
                <div class="grid grid-cols-1">
                    <div class="p-6 rounded-md bg-green-600/10 dark:bg-green-600/20">
                        <div class="md:flex items-center">
                            <img src="<?php echo $static_url; ?>/images/client/03.jpg" class="rounded-full size-28" alt="">

                            <div class="md:ms-4 md:mt-0 mt-4 md:flex justify-between items-end">
                                <div>
                                    <h5 class="text-2xl font-medium">Amber Durden <span class="text-base md:inline block md:mt-0 mt-2"><span class="text-slate-400"><span class="mdi mdi-circle-medium align-middle md:inline-block hidden"></span> Broker</span> of <a href="agency-profile.php" class="hover:text-green-600">Highrises Realty</a></span></h5>
                                    ...
                                    <ul class="list-none mt-2 md:flex items-center md:divide-x-[1px] divide-slate-400">
                                        ...
                                        <li class="md:inline-flex flex items-center md:mx-2 md:mt-0 mt-2 md:px-2"><i data-feather="phone" class="size-4 align-middle text-green-600 me-2"></i> +(458) 456-7854</li>
            ...
            <div class="container relative mt-6">
                <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                    ...
                    <div class="lg:col-span-8 md:col-span-7 order-1 md:order-2">
                        ...
                        <p class="text-slate-400 mt-3">Obviously I'M Property Broker. Property Broker with over 3 years of experience. Experienced with all stages of the agent or broker cycle for dynamic properties. The as opposed to using 'Content here, content here', making it look like readable English.</p>
                        <p class="text-slate-400 mt-3">Data Structures and Algorithms are the heart of programming. Initially most of the developers do not realize its importance but when you will start your career in software development, you will find your code is either taking too much time or taking too much space.</p>
                        ...
                        <div class="grid lg:grid-cols-2 grid-cols-1 mt-4 gap-[30px]">
                            ...
                            <!-- profile code  -->
                            <?php
                                include "$base_dir/Components/Pages/profile.php";
                            ?>
