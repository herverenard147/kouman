                    ...
                    <div class="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                        ...
                        <p class="text-slate-400">The most well-known dummy text is the 'Lorem Ipsum', which is said to have
                            ...
                            but it imitates the rhythm of most European languages in Latin script. The <b
                                ...
                                class="text-danger-600">meaninglessness</b> of Lorum Ipsum is that the text does not attract
                            attention to itself or distract the viewer's <b class="text-danger-600">attention</b> from the
                            layout.
                        </p>
                        ...
                        <div class="mt-6">
                            ...
                            <a href=""
                                class="btn bg-transparent hover:bg-green-600 border border-green-600 text-green-600 hover:text-white rounded-md ms-2">Decline</a>
                        </div>
                    </div>
                </div><!--end -->
            </div><!--end grid-->
