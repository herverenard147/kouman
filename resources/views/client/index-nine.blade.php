...
?>
        ...
        <!-- Hero Start -->
        <section class="relative overflow-hidden md:h-screen flex items-center md:py-0 py-36 bg-cyan-100 dark:bg-cyan-500/20 bg-[url('../../<?php echo $static_url; ?>/images/bg/bg3.png')] bg-no-repeat bg-top bg-cover">
            <div class="container relative">
                <div class="grid grid-cols-1 items-center mt-10">
                    <div class="md:text-start text-center">
                        <h1 class="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-6">We will find a perfect <br> home for you</span></h1>
