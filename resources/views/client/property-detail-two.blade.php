                        ...
                        <div class="grid grid-cols-1 relative">
                            <div class="tiny-one-item">
                                <div class="tiny-slide">
                                    <img src="<?php echo $static_url; ?>/images/property/single/1.jpg" class="rounded-md shadow dark:shadow-gray-700" alt="">
                                </div>

                                <div class="tiny-slide">
                                    <img src="<?php echo $static_url; ?>/images/property/single/2.jpg" class="rounded-md shadow dark:shadow-gray-700" alt="">
                                </div>

                                <div class="tiny-slide">
                                    <img src="<?php echo $static_url; ?>/images/property/single/3.jpg" class="rounded-md shadow dark:shadow-gray-700" alt="">
                                </div>

                                <div class="tiny-slide">
                                    <img src="<?php echo $static_url; ?>/images/property/single/4.jpg" class="rounded-md shadow dark:shadow-gray-700" alt="">
                                </div>

                                <div class="tiny-slide">
                                    <img src="<?php echo $static_url; ?>/images/property/single/5.jpg" class="rounded-md shadow dark:shadow-gray-700" alt="">
                                </div>
                            </div>
                        </div>
