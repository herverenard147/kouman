...
ob_start();
echo "$base_dir"; // This file contains the shared navlink content
include "$base_dir/navbar-light.php";
...
?>
        ...
        <section class="relative table w-full py-36 lg:py-44 overflow-hidden zoom-image">
            <div class="absolute inset-0 image-wrap z-1 bg-[url('../../<?php echo $static_url; ?>/images/bg/04.jpg')] bg-no-repeat bg-center bg-cover"></div>
