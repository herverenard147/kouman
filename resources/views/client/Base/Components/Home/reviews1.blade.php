...
<div class="tiny-slide">
    <div class="text-center mx-3">
        <p class="text-lg text-slate-400 italic"> " <?php echo $item['desc']; ?> " </p>
        ...
        <div class="text-center mt-5">
            ...
            <img src="<?php echo $static_url, $item['img']; ?>" class="size-14 rounded-full shadow-md dark:shadow-gray-700 mx-auto" alt="">
