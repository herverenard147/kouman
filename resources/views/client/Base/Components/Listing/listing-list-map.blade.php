...
<div
    class="group rounded-xl bg-white dark:bg-slate-900 shadow hover:shadow-xl dark:hover:shadow-xl dark:shadow-gray-700 dark:hover:shadow-gray-700 overflow-hidden ease-in-out duration-500 w-full mx-auto xl:max-w-4xl">
    <div class="xl:flex">
        <div class="relative xl:shrink-0">
            <img class="size-full object-cover xl:w-96" src="{{ asset('client/assets/' . $item['img']) }}" alt="">
