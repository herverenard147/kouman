...
Route::middleware(['guest:web'])->prefix('client')->group(function () {
    ...
    Route::get('mot-de-passe-oublie', [ForgotPasswordController::class, 'showLinkRequestForm'])->name('client.auth.re.password');
...
Route::middleware(['auth:client'])->group(function () {
    ...
    // Checkout
    Route::get('/mon-profil/commandes', [ClientProfileController::class, 'ordersHistory'])->name('client.profile.ordersHistory');
    Route::get('/mes-commandes/{id}', [ClientOrderController::class, 'show'])->name('client.orders.show');
